# =============================================================================
# MsituGuard - Smart Tree Planting Platform Views
# =============================================================================
...
# Local App Imports
from .models import (
    Profile, Resource, EmergencyContact, Report, ResourceRequest, 
    ForumPost, Comment, TreePlanting, TreePrediction
)
from .forms import (
    UserRegistrationForm, ResourceForm, ReportForm, ProfileForm, 
    ResourceRequestForm, ForumPostForm, FormComment, EditProfileForm, 
    PasswordChangingForm, UserForm
)
...
class UserLogoutView(LogoutView):
    """Custom logout view that redirects to homepage"""
